...
type Trace interface {
	// // SetTraceIDService set TraceID generator, default fcouIDGenerator
	// SetTraceIDService(IDService)
	// // SetTraceIDService set SpanID generator, default fcouIDGenerator
