...
import (
	...
	testdata "github.com/Fcou/web-frame/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/Fcou/web-frame/framework/gin.handlerNameTest$", c.HandlerName())
}
