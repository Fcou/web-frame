...
// NewFcouSSH 代表实例化Client
func NewFcouSSH(params ...interface{}) (interface{}, error) {
...
func (app *FcouSSH) GetClient(option ...contract.SSHOption) (*ssh.Client, error) {
