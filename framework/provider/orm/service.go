...
// FcouGorm 代表fcou框架的orm实现
type FcouGorm struct {
...
// NewFcouGorm 代表实例化Gorm
func NewFcouGorm(params ...interface{}) (interface{}, error) {
...
// GetDB 获取DB实例
func (app *FcouGorm) GetDB(option ...contract.DBOption) (*gorm.DB, error) {
