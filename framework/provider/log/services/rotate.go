...
// FcouRotateLog 代表会进行切割的日志文件存储
type FcouRotateLog struct {
	FcouLog
...
// NewFcouRotateLog 实例化FcouRotateLog
func NewFcouRotateLog(params ...interface{}) (interface{}, error) {
	// 参数解析
	...
	// 从配置文件中获取file信息，否则使用默认的fcou.log
	file := "fcou.log"
