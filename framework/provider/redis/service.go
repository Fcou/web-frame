...
// FcouRedis 代表fcou框架的redis实现
type FcouRedis struct {
...
// NewFcouRedis 代表实例化Client
func NewFcouRedis(params ...interface{}) (interface{}, error) {
...
func (app *FcouRedis) GetClient(option ...contract.RedisOption) (*redis.Client, error) {
	// 读取默认配置
